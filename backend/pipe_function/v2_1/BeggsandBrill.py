...
def Pgrad(f_user,P, T, oil_rate, wtr_rate, Gor, gas_grav, oil_grav, wtr_grav, d, angle):
    ...
    ftp = f_user*fn * math.exp(s)                                                    #Two-phase friction factor
    ...
    return (Pgrad_pe + Pgrad_f) / (1 - Ek)  , laml , muo   , usl,sigl ,qg*86400,regime ,usg , qo/ 6.2898*15387, qw/ 6.2898*15387, ql    /6.2898*15387                 #Overall pressure gradient, psi/ft
...
def  Pgrad2(P, T, oil_rate, wtr_rate, Gor, gas_grav, oil_grav, wtr_grav, d, angle):
    ...
    return (Pgrad_pe + Pgrad_f) / 144, laml, mul   , usl ,  qg  ,usg                         #Overall pressure gradient, psi/ft
